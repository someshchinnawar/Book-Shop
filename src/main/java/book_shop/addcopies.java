...
public class addcopies extends javax.swing.JFrame {
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        try{
            ...
            String query =  "update addbook set no_of_copies = ? where id = ?";
            PreparedStatement p = con.prepareStatement(query);

            p.setInt(1, Integer.parseInt(txtnoofcopies.getText()));
            p.setInt(2, Integer.parseInt(txtnewbookid.getText()));
        ...
        JOptionPane.showMessageDialog(null, "Added copies");
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://"+
                "localhost:3306/book_shop","root", "root");
            String query =  "select bookname , no_of_copies from addbook where id = ?";
            PreparedStatement p = con.prepareStatement(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addcopies.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
